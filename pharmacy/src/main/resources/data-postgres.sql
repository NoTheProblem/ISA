...
insert into registeredusers (tip,first_name,last_name,username,password,email,country,city,address, enabled, last_password_reset_date,loyaltyScore) values ('ROLE_USER','Zorana','Stamenkovic','zorana','$2a$10$gIodpuRGSH.7RUeBAMtX2OCrsSdqjBlRuLdTeqz5svZZcKHoQSwUK','zoranastamenkovic@gmail.com','Srbija','Novi Sad','Negde u NS',true, '2021-01-02 18:57:58.508-07',0);
...
insert into promotion(title, text, start_date, end_date, type, pharmacy_id) values('Bekutan akcija', 'Svi bekutan prozivodi su sada kod nas vamo tmao','2021-01-11', '2021-07-30','promocija',1);
